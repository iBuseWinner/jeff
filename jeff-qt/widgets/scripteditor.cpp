...
ScriptEditor::ScriptEditor(QWidget *parent, Basis *_basis, ExtensionsManager *_em, ModalHandler *m_handler) 
  : QWidget(parent), basis(_basis), em(_em), _m_handler(m_handler)
{
...
void ScriptEditor::change_stype() {
  ...
  //   }
  // if (stype == 0) {
  //   // Daemon (works in background and communicates with Jeff's server)
  ...
  //       return;
  //     }
  //     auto *extension_meta = new ExtensionMeta();
  //     extension_meta->is_server = false;
  //     extension_meta->
